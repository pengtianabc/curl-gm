...
static const struct helptxt helptext[] = {
  ...
  {"    --dcert <certificate[:password]>",
   "2th Client certificate file and password"},
  {"    --dcert-type <type>",
   "2th Certificate file type (DER/PEM/ENG)"},
  ...
  {"    --dkey <key>",
   "2th Private key file name"},
  {"    --dkey-type <type>",
   "2th Private key file type (DER/PEM/ENG)"},
  {"    --krb <level>",
